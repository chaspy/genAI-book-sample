...
1. hybrid_doc_02.txt：Elasticsearch による高性能検索システムの実装　→ 固有名詞「Elasticsearch」「監視」「設定」がすべて一致してトップ  
2. hybrid_doc_01.txt：BM25 アルゴリズムの実装詳細  
3. hybrid_doc_05.txt：RAG システムの最適化手法と実装戦略

ベクトル検索結果

1. hybrid_doc_02.txt：Elasticsearch による高性能検索システムの実装　→ 語彙一致が強くベクトルでも1位を維持  
...
1. hybrid_doc_02.txt：Elasticsearch による高性能検索システムの実装　→ キーワード一致を優先し実装記事が1位  
2. hybrid_doc_05.txt：RAG システムの最適化手法と実装戦略  
3. hybrid_doc_04.txt：開発者の生産性向上と創造的業務への集中

ベクトル検索結果

1. hybrid_doc_03.txt：検索技術の進化と意味理解の革命　→ embeddingとDense Retrievalの利点を直接説明  
...
1. hybrid_doc_05.txt：RAG システムの最適化手法と実装戦略　→ Dense Retrieval とRAG最適化を直球で解説  
2. hybrid_doc_03.txt：検索技術の進化と意味理解の革命  
3. hybrid_doc_02.txt：Elasticsearch による高性能検索システムの実装

ベクトル検索結果

1. hybrid_doc_05.txt：RAG システムの最適化手法と実装戦略　→ ベクトルでもRAG/Dense Retrieval文脈が最も合致  
2. hybrid_doc_03.txt：検索技術の進化と意味理解の革命  
